...
namespace Nbucic\AudioTts\Commands;

use Native\Mobile\Plugins\Commands\NativePluginHookCommand;

/**
 * Copy assets hook command for AudioTTS plugin.
 *
...
{
    protected $signature = 'nativephp:audio-t-t-s:copy-assets';

    protected $description = 'Copy assets for AudioTTS plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for AudioTTS');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for AudioTTS');
    }
}