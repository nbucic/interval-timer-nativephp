 ...
 * by NativePHP. Host tooling may run PHP 8.4; these new self() calls are a
 * drop-in equivalent that work everywhere.
 */
readonly class TimerCursor
{
    ...
    /** Resume into a named sub-state (the state that was active pre-pause). */
    ...
    public function isIdle(): bool       { return $this->state === StateMachine::idle; }
    public function isRunning(): bool    { return $this->state === StateMachine::running; }
    public function isPaused(): bool     { return $this->state === StateMachine::paused; }
    public function isInPause(): bool    { return $this->state === StateMachine::pause; }
    public function isInCooldown(): bool { return $this->state === StateMachine::cooldown; }
    public function isCompleted(): bool  { return $this->state === StateMachine::completed; }
}
