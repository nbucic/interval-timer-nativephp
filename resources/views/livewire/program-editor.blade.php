<div class="flex flex-col h-full">
                ...
                <div class="flex gap-2">
                    <button
                        ...
                        class="px-3 py-1.5 rounded-lg text-sm font-semibold transition-colors
                               {{ $beepLeadIn === 3 ? 'bg-blue-600 text-white' : 'bg-gray-800 text-gray-400' }}"
                    >3s</button>
                    <button
                        wire:click="$set('beepLeadIn', 5)"
                        class="px-3 py-1.5 rounded-lg text-sm font-semibold transition-colors
                               {{ $beepLeadIn === 5 ? 'bg-blue-600 text-white' : 'bg-gray-800 text-gray-400' }}"
                    >5s</button>
                </div>
            </div>
                ...
                <div class="flex items-center gap-2 bg-gray-900 rounded-2xl px-3 py-3 border border-white/5">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-gray-500 text-xs mt-0.5">
                            ...
                            @if($phase['pause'] > 0)· {{ $phase['pause'] }}s pause @endif
                            @if($phase['cooldown'] > 0)· {{ $phase['cooldown'] }}s cooldown @endif
                        </p>
                    </div>
    ...
    >
        <div class="w-full bg-gray-900 rounded-t-2xl safe-bottom max-h-[90vh] overflow-y-auto"
            ...
            <div class="sticky top-0 bg-gray-900 flex items-center justify-between px-5 py-4 border-b border-white/5">
            ...
            <div class="px-5 py-5 space-y-5">
                ...
                {{-- Label --}}
                <div>
                    <label class="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1.5">Phase Name</label>
                    <input
                        type="text"
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" wire:model="phaseReps" min="1" max="50"
                               class="w-full bg-gray-800 text-white rounded-xl px-4 py-3
                                      border border-white/10 focus:border-blue-500 focus:outline-none text-center text-lg font-bold">
                ...
                {{-- Colour --}}
                <div>
                    <label class="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Colour</label>
                ...
                <div class="flex gap-3 pb-2">
                    ...
                    >{{ $editingPhaseIndex !== null ? 'Update' : 'Add' }} Phase</button>
                </div>
